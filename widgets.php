	...
	*/
	...
	class AKVO_WIDGETS_TEMPLATE{
		...
		function assets(){
			...
			wp_enqueue_script('akvo-sow-script', plugins_url('akvo-siteorigin-widgets/widget.js'), array('jquery'), '2.0.0', true );
			wp_enqueue_style('akvo-sow-styles', plugins_url('akvo-siteorigin-widgets/style.css'), false, '2.0.0' );
		}
